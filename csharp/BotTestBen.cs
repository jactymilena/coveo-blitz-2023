...
//         if(!_bomb && !_bombBlocker && AllPath100Percent() && _bombAmount < _paths.Count()) 
//         {
//             _bomb = true;
//         }
//         else
...
//         {
//             if (tower.Value.Price <= currentMoney)
//             { // TODO check if money left
...
//             var start = _paths[_bombAmount][0];
//             for (int x = _paths.X - range; x <= _paths.X + range; x++)
//             {
//                 for (int y = _paths.Y - range; y <= _paths.Y + range; y++)
//                 {
//                      if(TileIsValid)
//                     {
